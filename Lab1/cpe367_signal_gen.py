...
def gen_wav(fpath_wav_out):
	...
	num_samples = 1000 # time for 1/16 of a seccond
	w1 = 2 * math.pi * 160 / sample_rate_hz #f of 160Hz
	A = 32767 # max amplitude for 16 bit-signed
	...
	for n in range(num_samples):
		...
		# absolute value of sinusoid
		yout = abs(A * math.cos(w1 * n))
